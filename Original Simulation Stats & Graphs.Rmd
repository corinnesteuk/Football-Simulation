...
prob_failure <- no_td/length(d)
prob_failure
```

## Decision Distribution

**Sample from a Bernoulli Distribution with probability of that a decsiion is a run play (==1) is .567**
...
x_comp <- seq(3, 75, 1)
y_comp <- .97^(x_comp)
plot(x_comp, y_comp, main = "Probability of Completing a Pass Given its Length", xlab = "Yardage", ylab = "Completion Probability")
