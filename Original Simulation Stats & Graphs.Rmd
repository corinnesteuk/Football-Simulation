...
The next change was to simulate drives with only run plays. The probability significantly decreased making it very unlikely for a team to score a touchdown from only run plays. 
```{r, echo = FALSE}
play_run <- function() {
   yardage <- round(rnorm(1, mean = 3, sd = 3))
}
